...
$('.additem').live('click', function () {
    ...
    $('#menumanager2').load(base_url + 'restaurant/menu_form/' + id + '/' + res_id, function () {
        ...
        $.ajax({
            ...
            {
                $('#addMenuModel .modal-footer').prepend('<select class="loadPrevious btn" id="loadPrevious'+id+'">'+addons+'</select><a id="add_additional'+id+'" class="btn btn-secondary-outline  add_additional ignore ignore2 ignore1" href="javascript:void(0)">Add Addon</a>'+
