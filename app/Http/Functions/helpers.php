<?php
    ...
    function newrow($new = false, $name = false, $class = "", $required = false, $columns = 9, $labelStr = ""){
        ...
        if ($new) {
            ...
            return '<div class="form-group row editaddress ' . $class . '"><label class="col-sm-3 text-xs-right' . $required . '" id="' . $id . '">' . $name . '<span class="alldays">' . $labelStr . '</span>
...
//prints a rating
    function rating_initialize($type = "rating", $load_type = "", $target_id = 0, $TwoLines = false, $class_name = 'update-rating', $add_rate_brn = true, $select_rating_starts = false) {
        $html = "<DIV>";
