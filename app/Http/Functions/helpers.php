<?php
    ...
    function newrow($new = false, $name = false, $class = "", $Required = false, $columns = 9, $labelStr = "")
    {
        ...
        if ($new) {
            return '<div class="col-md-12 col-sm-12 col-xs-12"><div class="form-group ' . $class . '"><label class="control-label' . $Required . '" id="' . $id . '">' . $name . '</label><BR>' . $labelStr;
            ...
            return '<div class="form-group row editaddress ' . $class . '"><label class="col-sm-3 text-xs-right' . $Required . '" id="' . $id . '">' . $name . '<br/><span class="alldays">' . $labelStr . '</span>
