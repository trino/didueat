...
//converts a CSV array into one where each value is in a single quote
    ...
    function popup($Success, $Message, $Title = "", $ID = ""){
        ...
        if($ID){ echo ' ID="' . $ID  . '"';}
        echo '><div class="container" style="margin-right:auto;margin-top:0 !important; padding:0 !important;"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>';
