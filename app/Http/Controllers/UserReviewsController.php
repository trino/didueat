<?php
    ...
    class UserReviewsController extends Controller
    {
        ...
        public function ajaxGetReviewUsersList() {
            ...
            $type = $post['type'];
            $data['detail'] = \App\Http\Models\RatingUsers::select('user_id', 'target_id', 'comments', 'created_at', 'rating')->where('rating_id', $rating_id)->where('type', $type)->where('target_id', $target_id)->get();
            $data['type'] = $type;
