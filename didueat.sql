...
insert  into `menus`(`id`,`restaurant_id`,`menu_item`,`description`,`price`,`additional`,`has_addon`,`image`,`type`,`parent`,`req_opt`,`sing_mul`,`exact_upto`,`exact_upto_qty`,`display_order`,`cat_id`) values (1,1,'Item pop1','ahdkjfah kjfah sdkjfh akjsdh fkjads hfkjasd hfakjs dhfkja sdhkjf ahkdsj fhakjsd hfkjas dhfkja dshfkj hasdkjfh askjdh kjas hfkjas dhfkja shdfkj ahsdkjf hadskj fhakjsd hfkjasd hfkja sdhfkjasdhkjfahs dkjfh ads fa dskj fhakjsdh fkjasdh kjfha',10,NULL,0,'undefined',NULL,0,NULL,NULL,NULL,NULL,1,1),(2,1,'Item pop2','ahsdfkj ahsdkjf hadskjf hakjds fhakjds ',20,NULL,1,'undefined',NULL,0,NULL,NULL,NULL,NULL,1,1),(3,1,'addons','adkahd fkjah sdkjf hakjsd hfkja shdkj',0,NULL,0,NULL,NULL,2,0,1,0,'',1,0),(4,1,'item2',NULL,10,NULL,0,NULL,NULL,3,NULL,NULL,NULL,NULL,2,0),(5,1,'item1',NULL,5,NULL,0,NULL,NULL,3,NULL,NULL,NULL,NULL,1,0),(6,1,'Item pop3','hakjd fhakjds hfakjds fhakjs dhk',10,NULL,0,'undefined',NULL,0,NULL,NULL,NULL,NULL,1,1),(7,1,'Item pop 1','ahdsfka sdfjh askdfh akjsd ',20,NULL,0,'undefined',NULL,0,NULL,NULL,NULL,NULL,1,1),(8,1,'test main','ajdfkal sdjflka sjdl fjaskl',10,NULL,0,'undefined',NULL,0,NULL,NULL,NULL,NULL,1,3);
...
insert  into `notification_addresses`(`id`,`user_id`,`address`,`is_default`,`type`) values (1,2,'skpsoftech+786@gmail.com',1,'Email'),(2,2,'123456789',1,'Phone'),(3,1,'skpsoftech@gmail.com',1,'Email'),(4,1,'03225892509',1,'Phone'),(5,3,'skpsoftech+3@gmail.com',1,'Email'),(6,3,'01234',1,'Phone'),(7,4,'skpsoftech+4@gmail.com',1,'Email'),(8,4,'01234',1,'Phone');
...
CREATE TABLE `page_views` (
  ...
  `type` enum('menu','order','restaurant') DEFAULT NULL,
...
insert  into `profiles`(`id`,`profile_type`,`name`,`email`,`password`,`photo`,`subscribed`,`restaurant_id`,`created_by`,`status`,`created_at`,`updated_at`,`deleted_at`) values (1,1,'Waqar Javed','skpsoftech@gmail.com','$2y$10$xBMJJ5dMaHjZfrNJ4FJ2quPFeded7DWO8ldgStzPQRP0F5xADYjd6','20151112112433.png',1,1,29,1,'2015-10-08 22:31:39','2015-11-12 16:24:35',NULL),(2,2,'Waqar','skpsoftech+786@gmail.com','$2y$10$F0yUpqu36aSz0/FahVy2ieU0mIHiAuVBmvqvZMUhSgqiywDQIhS0.',NULL,1,1,0,0,'2015-11-18 02:36:38','2015-11-18 09:46:26',NULL),(3,2,'waqar2','skpsoftech+3@gmail.com','$2y$10$1rvhNN.ZPH3vCLc6ZVudmOBgAU9pMG8JcYYH6pIQG1948zpOLl6ee',NULL,0,2,0,0,'2015-11-19 09:07:36','2015-11-19 09:07:36',NULL),(4,2,'Waqar Javed','skpsoftech+4@gmail.com','$2y$10$UC332elK75hRVk7XaA3uX.xl8B.rAfeqFIPW6degG8jCSh0E0ZZuO',NULL,1,3,0,0,'2015-11-19 10:04:38','2015-11-19 10:04:38',NULL);
...
insert  into `profiles_addresses`(`id`,`user_id`,`location`,`address`,`phone_no`,`post_code`,`apartment`,`buzz`,`city`,`province`,`country`) values (1,2,NULL,'Street Address','123456789','123456',NULL,NULL,'1553',2,40),(2,1,'Test Location','Street Address','123456789','123456',NULL,NULL,'201',2,40),(3,1,'Location Name5','test Address5','01234','123456','appartment','123456','15',1,40),(4,1,'Location Name6','test Address6','01234','123456','appartment2','123456','1185',8,40),(5,4,NULL,'test Address2','01234','123456',NULL,NULL,'1',1,40);
...
insert  into `rating_define`(`id`,`title`,`type`) values (1,'Service','restaurant'),(2,'Quality','restaurant'),(3,'Pricing','restaurant'),(4,'Taste','menu'),(5,'Price','menu'),(6,'Quality','menu');
...
insert  into `rating_users`(`id`,`user_id`,`target_id`,`rating_id`,`rating`,`comments`,`type`,`created_at`,`updated_at`,`deleted_at`) values (1,1,1,2,4,NULL,'restaurant','2015-11-20 13:29:15','2015-11-20 13:29:15',NULL),(2,1,1,5,4,NULL,'menu','2015-11-20 13:32:37','2015-11-20 13:32:37',NULL),(3,1,2,5,3.5,NULL,'menu','2015-11-20 13:36:08','2015-11-20 13:36:08',NULL),(4,1,1,4,5,NULL,'menu','2015-11-20 13:45:05','2015-11-20 13:45:05',NULL),(5,1,1,1,4,NULL,'restaurant','2015-11-20 16:23:07','2015-11-20 16:23:07',NULL),(6,1,1,6,4,NULL,'menu','2015-11-20 16:36:39','2015-11-20 16:36:39',NULL),(7,1,2,6,4,NULL,'menu','2015-11-20 16:36:45','2015-11-20 16:36:45',NULL),(8,1,8,5,2.5,NULL,'menu','2015-11-20 16:36:53','2015-11-20 16:36:53',NULL);
...
CREATE TABLE `restaurants` (
  ...
  `delivery_fee` decimal(3,0) DEFAULT NULL,
  `minimum` decimal(3,0) DEFAULT NULL,
...
insert  into `restaurants`(`id`,`name`,`slug`,`genre`,`phone`,`address`,`city`,`province`,`country`,`postal_code`,`description`,`logo`,`delivery_fee`,`minimum`,`open`) values (1,'Restaurant 1','restaurant-1',1,'123456789','Street Address','250','7','40','123456','adjfakldf aklsdj fklas ','restaurant-1.jpg','0','0',1),(2,'Test Restaurant2','test-restaurant2',1,'01234','test Address5','15','1','40','123456','ajldk fjaksd fjlaks djfklas ',NULL,'10','50',0),(3,'Test Restaurant4','test-restaurant4',1,'01234','test Address2','1','1','40','123456','ajksdlf asjdklf jasl',NULL,'10','15',0);
