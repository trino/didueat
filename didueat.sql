...
insert  into `newsletter`(`ID`,`Email`,`GUID`) values (1,'info@trinoweb.com','');
...
insert  into `notification_addresses`(`ID`,`RestaurantID`,`Address`,`Type`) values (1,1,'32424234234','Phone'),(2,1,'info@trinoweb.com','Email'),(3,1,'1234','Phone');
