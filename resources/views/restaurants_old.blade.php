            ...
            <div class="row margin-bottom-10" style="padding:0px;margin-top:0px">
                <div class="col-md-3 col-sm-3 col-xs-12  top-cart-block">
                    <div class="box-shadow" style="padding-left:10px">
                        ...
                        <div style="margin-right:10px;margin-bottom:10px;margin-top:0px;text-align:center;padding:0px;padding-bottom:10px;border-bottom:solid #000 1px">
                            <label for="searchBtn" style="padding:0px;margin:0px">
                                <h3 style="display:block;margin-bottom:5px">Refine Search With<br/>Options Below</h3>
                            </label>
                            <input class="btn btn-default nearby-res-btn srchBtnRnd" style="margin:0px;border-radius:8px" id="searchBtn" type="button" title="Click to Refine Your Search Results" onclick="refineSelection()" value="Find Nearby Restaurants">
                        </div>
                        ...
                        <div class="container-fluid" style="margin:0px;padding:0px">
                            ...
                            <div class="row margin-bottom-10" style="padding:0px;margin-top:0px">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12" align="left"><br/><br/>
                                    ...
                                    <div class="btn-group">
                                        <button type="button" id="cuisinesBtn" class="btn btn-danger" data-toggle="dropdown" style="background:#ff1a1a;font-weight:bold" onclick="cuisineOpn = false;
                                                                          showCuisines()">Select Cuisines</button>
                                        <button type="button" id="cuisinesCaret" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" style="background:#ff1a1a;border-left:solid #770000 2px" onclick="cuisineOpn = false;
                                                                          showCuisines()">
                                            <span class="caret"></span>
                                        </button>
