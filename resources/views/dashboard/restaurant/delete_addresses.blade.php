            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-title">
                        Notifications
                        <button type="button" class="btn btn-danger btn-sm editAddress" data-toggle="modal"
                            ...
                            <tr class="rows" data-id="{{ $value->id }}" data-order="{{ $key }}">
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm editAddress" data-toggle="modal"
                                       data-target="#editAddressModal" data-id="{{ $value->id }}">Edit</a>
                                ...
                                <td>
                                    <div class="btn-group-vertical">
                                        <a class="btn btn-secondary-outline up btn-sm"><i
