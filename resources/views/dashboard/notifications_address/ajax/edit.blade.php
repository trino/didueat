...
<div class="modal-body">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                <label class="control-label col-md-3">Phone Type</label>
                <div class="col-md-9 reach_type" style="padding-top: 8px;">
                    <label>
                        <input type="radio" name="is_call" id="is_call" value="1" @if(isset($address_detail->is_call) && $address_detail->is_call == 1) checked @endif onchange="uncheck('is_sms');"> Call
                    </label> &nbsp;
                    <label>
                        <input type="radio" name="is_sms" id="is_sms" value="1" @if(!isset($address_detail) || (isset($address_detail->is_sms) && $address_detail->is_sms == 1)) checked @endif onchange="uncheck('is_call');"> SMS
                    </label>
                </div>
            </div>
        </div>
