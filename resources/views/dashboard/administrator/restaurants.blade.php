                                ...
                                @foreach($restaurants_list as $value)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($value->open == true)
                                                <a href="{{ url('restaurant/list/status/'.$value->id) }}" class="btn btn-warning" onclick="return confirm('Are you sure you want to close this Restaurant ?');">Close</a>
                                            @else
                                                <a href="{{ url('restaurant/list/status/'.$value->id) }}" class="btn green" onclick="return confirm('Are you sure you want to open this Restaurant ?');">Open</a>
                                            @endif
                                            <a href="{{ url('restaurant/list/delete/'.$value->id) }}" class="btn btn-primary" onclick="return confirm('Are you sure you want to delete Restaurant One?');">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
