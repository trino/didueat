...
<div class="margin-bottom-40">
    ...
    <div class="intro">
        <div class="text">
            Did U Eat is dedicated to connecting local restaurants to hungry customers. Instead of having an exhausting
            menu for customers to look through, we do things a bit differently. Our restaurants feature a meal of the
            day for each day of the week. The customer simply selects the food category they feel like having, choose
            ...
            By putting your restaurant online with Did U Eat, you'll be getting more business from hungry customers in
            your local area
            Diners on our sites browse your menu and place an order from their computer or web app. Once that's done,
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-xs-12">
                                        <input type="text" name="name" id="name" class="form-control required"
                                               value="{{ old('name') }}" placeholder="i.e. Pho" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <select name="country" id="country" class="form-control" required>
                                            ...
                                            @foreach($countries_list as $value)
                                                <option value="{{ $value->id }}"
                                                        @if(old('country') == $value->id) selected @endif>{{ $value->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <input type="text" name="province" id="province" class="form-control"
                                               placeholder="Province Name" value="{{ old('province') }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                        <input type="text" name="address" id="address" class="form-control"
                                               value="{{ old('address') }}" placeholder="i.e. 1230 Main Street East"
                                               required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <input type="text" name="city" id="city" class="form-control"
                                               placeholder="i.e. Hamilton" value="{{ old('city') }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <input type="text" name="postal_code" id="postal_code" class="form-control"
                                               value="{{ old('postal_code') }}" placeholder="i.e. L9A 1V7" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-5 col-sm-5 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="minimum" class="form-control required"
                                       placeholder="Minimum Sub Total For Delivery" value="{{ old('minimum') }}"
                                       required>
                            </div>
                        </div>
                        <div class="clearfix"></div>
