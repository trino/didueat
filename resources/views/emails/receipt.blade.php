...
<html xmlns="http://www.w3.org/1999/xhtml">
    <body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" @if(!isset($order)) style="width:100%" @else style="width:800px" @endif>
        ...
        ?>
        <h4 style="margin-left:10px">Order Status:&nbsp; <span style="color:#f00">{{$order->status}}</span><!--br/><span style="font-weight:normal;">Note: You will receive a confirmation email when your order has been finalized</span></span></h4>
