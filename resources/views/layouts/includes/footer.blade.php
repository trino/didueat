        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-3">
                <div class="product-main-image">
                    <img src="{{ url('assets/images/products/model7.jpg') }}" alt="Cool green dress with red bell" class="img-responsive">
                </div>
                <div class="product-other-images">
                    <a href="#" class="active"><img alt="Berry Lace Dress" src="{{ url('assets/images/products/model3.jpg') }}"></a>
                    <a href="#"><img alt="Berry Lace Dress" src="{{ url('assets/images/products/model4.jpg') }}"></a>
                    <a href="#"><img alt="Berry Lace Dress" src="{{ url('assets/images/products/model5.jpg') }}"></a>
                </div>
            </div>
