                ...
                <div class="addmore ignore ignore1" id="addmore<?php if (isset($child)) echo $child->id; else echo '0';?>">
                    ...
                    <div class="cmore ignore ignore1" id="cmore<?php echo $cc->id;?>">
                        ...
                        <div class="resturant-arrows col-md-2 col-sm-2 col-xs-12">
                            <a href="javascript:void(0)" id="child_up_<?php echo $cc->id;?>" class="sorting_child"><i
                                        class="fa fa-angle-up"></i></a>
                            <a href="javascript:void(0)" id="child_down_<?php echo $cc->id;?>" class="sorting_child"><i
                    ...
                    <div class="cmore ignore ignore2 ignore1">
                        <div class="col-md-8 col-sm-8 col-xs-8 nopadd ignore ignore2 ignore1">
                            <input class="form-control cctitle ignore ignore2 ignore1" type="text" placeholder="Item"/>
                            <input class="form-control ccprice ignore ignore2 ignore1" type="text" placeholder="Price" style="margin-left:10px;"/>
                        </div>
                ...
                <div class="radios ignore ignore2 ignore1">
                    ...
                    <div <?php if(!isset($child->sing_mul) || (isset($child->sing_mul) && $child->sing_mul == 1)){?>style="display: none;" <?php } ?> class="infolist exact ignore ignore2 ignore1">
                        ...
                        <div class="ignore ignore2 ignore1">
                            <div style="padding-left:0;" class="col-xs-12 col-sm-4 ignore ignore2 ignore1">
                            ...
                            <div class="col-xs-12 col-sm-8 ignore ignore2 ignore1">
                                ...
                                <input type="hidden" class="up_t ignore ignore2 ignore1"
                                       ...
                                       <?php }else{?>value="1"<?php }?> /><input type="radio" onclick="$(this).parent().find('.up_t').val(0);" <?php if(!isset($child->exact_upto) || (isset($child->exact_upto) && $child->exact_upto == 0)){?> checked="checked" <?php }?> class="up_to up_to_selected ignore ignore2 ignore1" value="0" name="<?php echo $r3;?>"> Up to &nbsp; <input type="radio" onclick="$(this).parent().find('.up_t').val(1);" class="up_to ignore ignore2 ignore1" value="1" name="<?php echo $r3;?>" <?php if(isset($child->exact_upto) && $child->exact_upto == 1){?> checked="checked"<?php }?>> Exactly
                            </div>
