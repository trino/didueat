            ...
            <div class="form-group">
                <div class="">
                    <p class="pull-right"><a
                                href="mailto:info@didueat.ca?subject=Address%20Change%20On%20Didu%20Eat&amp;body=Please Update the Address as Follows:%0A%0A
{{ $GLOBALS['thisIdentity'] }}
                                        ...
                                        Contact Number:
                                        %3A%0A%0A
                                        Thank you" style="text-decoration:underline" title="{{ $alts["contactus"] }}">Update
                            restaurant address</a></p>
        ...
        @if( (Request::path() == '/' || Request::path()=='restaurants/chuck-burger-bar/menu' || (isset($searchTerm) && Request::path() == "restaurants/".$searchTerm) || (isset($slug) && Request::path() == "restaurants/".$slug."/menu")))
            ...
            <div class="dropdown-menu dropdown-menu-left">
                ...
                <a href="#" data-target="#editModel" data-toggle="modal" data-route="reservation" id="addNew"
                   title="{{ $alts["add"] }}" class="dropdown-item">New Address</a>
            </div>
            <?php }
            }else{
            ...
            <!--div class=" form-group pull-right">
                <a href="#" data-target="#editModel" data-toggle="modal" data-route="reservation" class="addNew"
                   title="{{ $alts["add"] }}" data-id='0' value="add_address">New Address</a>
            </div-->
            <?php
            }
            ?>
        ...
        @else
            <div class="form-group nowrap" <?php if (isset($type) && read('id')) {
                echo "style='display:none'";
            } ?> >
                <input type="text" name="<?php echo (isset($type)) ? 'address' : 'formatted_address' . $GUID;?>"
                       required
...
@if(!isset($type))
    ...
    @if($slim)
        <div class="form-group slim">
            <input type="text" name="apartment" notrequired="true" id="apartment" class="form-control "
                   placeholder="{{ $aptUnit }}"/>
        </div>
    @else
        ...
        @if(false)
            ...
            <input type="text" name="apartment" class="form-control" notrequired="true"
...
@else
    ...
    <DIV id="pcNotFnd" style="display:none;margin-top:0px;margin-bottom:0px;color: red"
         class="col-md-12 text-xs-center"></div>
