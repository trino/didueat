...
<div class="<?php if (!isset($type)) echo "nput-group-btn";?> addressdropdown">
    <?php if(true){
                            ...
                            <div class="dropdown-menu dropdown-menu-left">
                                <?php
                                    foreach ($addresses as $address) {
                                        ...
                                        echo '" onclick="addresschanged(this)">' . $address->location . ' [' . $address->address . ']';
                                        echo '</a>';
                                    }
                                ?>
        ...
        @if($is_disabled)
            <input type="text" id="formatted_address<?php if (isset($type)){ echo '3';}?>" disabled name="formatted_address" class="form-control"
...
<?php
    if(isset($restSignUp)){
        echo '<div id="verifyAddress" style="display:none">';
        echo newrow($new, "Important", "", true, 10, true);
        echo '<div class="instruct">Please Ensure Address was Correctly Filled-out</div></div>';
        echo newrow();
    }
