    ...
    <div class="col-sm-9">
        <div class="input-icon">
            <input type="text" name="first_name" class="form-control"
                   value="{{ (isset($credit_cards_list->first_name))?$credit_cards_list->first_name:'' }}"
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input type="text" name="last_name" class="form-control"
               value="{{ (isset($credit_cards_list->last_name))?$credit_cards_list->last_name:'' }}"
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input type="number" name="card_number" class="form-control"
               value="{{ (isset($credit_cards_list->card_number))?$credit_cards_list->card_number:'' }}"
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input type="number" name="ccv" class="form-control"
               value="{{ (isset($credit_cards_list->ccv))?$credit_cards_list->ccv:'' }}" id="ccv"
