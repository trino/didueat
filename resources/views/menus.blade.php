                                ...
                                @if($canedit)
                                    ...
                                    <div class="pull-right" aria-label="Basic example">
                                        <A title="{{ $alts["deletecat"] }}" class="btn btn-sm btn-link pull-right"
                                           onclick="deletecategory({{ $thisCatCnt . ", '" . addslashes($value->cat_name) . "'"}});">
                                            <i class="fa fa-times"></i>
                                        </A>
                                        <A title="{{ $alts["editcat"] }}" class="btn btn-sm btn-link pull-right"
                                           data-toggle="modal"
                                           data-target="#editCatModel" data-target-id="{{ $thisCatCnt }}"
                                           onclick="editcategory({{ $thisCatCnt . ", '" . addslashes($value->cat_name) . "'"}});">
                                            Edit
                                        </A>
    ...
    padding-bottom:  .5rem !important;" class="list-group-item parents"
                    ...
                    <a
                        ...
                        <div>
                            ...
                            parent{{ $value->cat_id }}_{{ $value->display_order }}, {{ $value->id }}
                                            , {{ $value->cat_id }}, {{ $value->display_order }}
                                            , 'down', {{ $catMenuCnt }}
                        </span>
                                        <a href="#"
