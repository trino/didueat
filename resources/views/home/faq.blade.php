...
The best way to deal with a problem with your order, whether it contains the wrong items, or if there is some other problem, is to contact the restaurant itself. The restaurant is best prepared to deal with your concerns, as they are the ones who have prepared it, packaged it, and delivered it. The contact number for the restaurant can be found in your order confirmation email.<div class="smBR"><br/><br/></div>{{ DIDUEAT }} is very concerned with your satisfaction, so if you have contacted the restaurant with your concerns, and you still are not satisfied, then please chat live with one of our representatives on our online chat service.
  </div>
 <div class="clearfix"></div>
</div>
