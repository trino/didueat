...
<button type="button" class="btn btn-info col-lg-9 btn-responsive2 questions" data-toggle="collapse" data-target="#faq1" onclick="chngIcon(1)">How soon will my order arrive?
<div id="ic1" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></div></button>
...
<div class="col-lg-9">
<button type="button" class="btn btn-info col-lg-9 btn-responsive2" style="text-align:left;padding-left:7px;margin:2px" data-toggle="collapse" data-target="#faq2" onclick="chngIcon(2)">If I have questions, can I call the restaurant?
<div id="ic2" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></div></button>
...
<div class="col-lg-9">
<button type="button" class="btn btn-info col-lg-9 btn-responsive2" style="text-align:left;padding-left:7px;margin:2px" data-toggle="collapse" data-target="#faq3" onclick="chngIcon(3)">What do I do if I have a problem with my order after it has arrived?
<div id="ic3" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></div></button>
...
<div id="ic4" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></div></button>
...
<span id="ic5" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic6" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic7" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic8" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<div class="col-lg-9">
<button type="button" class="btn btn-info col-lg-9 btn-responsive2" style="text-align:left;padding-left:7px;margin:2px" data-toggle="collapse" data-target="#faq9" onclick="chngIcon(9)">What steps do I take to order my food?
<span id="ic9" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<div class="col-lg-9">
<button class="btn btn-danger col-lg-9 questions btn-responsive2" style="cursor:not-allowed;font-weight:bold">General Questions About Using Didu Eat</button>
</div>
...
<span id="ic20" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic21" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic23" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic24" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic25" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic27" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic29" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic30" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic31" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic32" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic34" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic40" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic41" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic42" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic43" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<div class="col-lg-9">
<button class="btn btn-danger col-lg-9 questions btn-responsive2" style="cursor:not-allowed;font-weight:bold">Managing Your Didu Eat Account</button>
...
<span id="ic50" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic51" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic52" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic53" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic70" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic71" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic72" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic73" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic74" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic80" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic81" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
...
<span id="ic82" class="glyphicon glyphicon-chevron-down pull-right glyphUp padL"></span></button>
