        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <DIV class="col-lg-12" align="right">
                    ...
                    ?>
                    <A HREF="{{ url("restaurant/list?fixmenus") . "&" . $returnurl }}" class="btn btn-primary btn-sm">Fix
                        Menus</A>
                    ...
                    <a href=" {{ url("home/debugmode") . "?" . $returnurl }}&action=clearcache"
                       class="btn btn-primary btn-sm">Clear Cache</a>
                ...
                <PRE style="width: 100%"><?php
                    ...
                    ?></PRE>
                <FORM METHOD="post">
                    <TEXTAREA NAME="hash" style="width:100%;"
                              placeholder="Email hash verifier"><?php if (isset($_POST["hash"])) {
                            echo $_POST["hash"];
                        } ?></textarea>
                    <?php
                    if (isset($_POST["hash"])) {
                    ...
                    ?>
                    <INPUT TYPE="text" name="hash2" placeholder="Hash to compare"
                           value="<?php if (isset($_POST["hash2"])) {
                               echo $_POST["hash2"];
                           } ?>">
