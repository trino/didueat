        ...
        <div class="modal-body">
          ...
          <div class="subitems_{{ $value->id }} optionals">
            ...
            <div class="col-xs-12 add-btn">
              ...
              <button id="clear_{{ $value->id }}" title="{{ $alts["reset"] }}" data-dismiss="modal" class="btn btn-warning resetslider" type="button" debug="uses resetslider in restaurants-menus.blade">
                RESET
              </button>
              <div class="clearfix"></div>
            </div>
