                                                ...
                                                <div class="col-xs-6 col-md-6"
                                                    ...
                                                    <div class="pad-17">
                                                        <a title="" id="buttons_{{ $mm->id }}" class="buttons btn-plain" href="javascript:void(0);">
                                                            ...
                                                            <input type="{{ ($sub->sing_mul == '1') ? 'radio' : 'checkbox' }}" id="extra_{{ $mm->id }}" title="{{ $mm->id.'_<br/> '.$mm->menu_item.'_'.$mm->price.'_'.$sub->menu_item }}" class="extra-{{ $sub->id }}" name="extra_{{ $sub->id }}" value="post" /> &nbsp;&nbsp; {{ $mm->menu_item }} &nbsp;&nbsp; <?php if ($mm->price) echo "(+ $" . number_format(str_replace('$', '', $mm->price), 2) . ")"; ?>
