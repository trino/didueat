...
return [
    ...
    "exception" => array('code' => '100', 'message' => "Unexpected error has occurred."),
    "user_logout" => array('message' => "You have been logged out successfully."),
    "user_inactive" => array('code' => '101', 'message' => "This account has been blocked. Contact us for more details"),
    "user_login" => array('message' => "Login successful."),
